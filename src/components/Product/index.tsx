...
const mapStateToProps = (state: { ui: { isLoading: any; }; products: { updatedProduct: any; updatedListName: any; }; }) => {
  return {
...
const mapDispatchToProps = (dispatch: (arg0: any) => any) => {
  return {
    handleWishListButtonPress: (id: any) => dispatch(wishListButtonPressAction(id)),
    handleShoppingListButtonPress: (id: any) => dispatch(shoppingCartButtonPressAction(id)),
